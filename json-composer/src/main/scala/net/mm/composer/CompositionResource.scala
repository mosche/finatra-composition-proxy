...
class ResourceById[K: ParamConverter](resolver: Executor[K, _], clazz: Class[_]) extends CompositionResource {
...
class ResourceByIds[K: ParamConverter](resolver: Executor[K, _], clazz: Class[_]) extends CompositionResource {
